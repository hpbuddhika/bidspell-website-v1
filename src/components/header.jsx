  ...
  <header className="box-border	 h-20 font-sans font-normal text-lg tracking-wide antialiased text-gray-600">
    <div className="max-w-screen-xl	h-20 m-auto">
      <div className="flex h-full py-6 ">
        ...
        <div className="flex-initia mx-4 cursor-pointer	">Monetization</div>
        <div className="flex-initia mx-4 cursor-pointer	">Platform</div>
        ...
        <div className="flex-1 self-center text-right">
          <button class="bg-red-400	 py-2 px-4  mb-0 text-white	 transition duration-500 ease-in-out  transform hover:-translate-y-1 hover:scale-105  hover:bg-red-500	 rounded inline-flex items-center  cursor-pointer">
            <span class="mr-1">Get a demo</span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
